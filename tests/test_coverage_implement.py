...
class TestUtilsExtended:
    ...
    def test_reporting_pdf_with_reportlab_fallback(self):
        ...
        try:
            ...
            with patch('builtins.__import__', side_effect=ImportError("weasyprint not found")):
                with patch('agid_assessment_methodology.utils.reporting.reportlab', create=True):
                    # Mock reportlab canvas
                    mock_canvas = MagicMock()
                    with patch('agid_assessment_methodology.utils.reporting.canvas.Canvas', return_value=mock_canvas):
